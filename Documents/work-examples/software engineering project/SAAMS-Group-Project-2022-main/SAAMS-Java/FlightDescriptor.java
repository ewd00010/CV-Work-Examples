...
public class FlightDescriptor {
   ...
   * @label contains
   * @directed*/
  private PassengerList flightPassengerList;
  /**
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FlightDescriptor)) return false;

    FlightDescriptor fd = (FlightDescriptor) o;
    return fd.getFlightCode().equals(flightCode)
            && (fd.getItinerary().equals(flightItinerary))
            && (fd.getPassengerList().equals(flightPassengerList));
  }
